...
namespace Rift.Frontend
{
  public partial class MainWindow : Window, IComponentConnector
  {
    ...
    FirstChanceExceptionEventArgs e)
    {
      ...
      switch (exception)
      {
        case WebException webException:
          if (MainWindow.IgnoreWebExceptions || webException.Status == WebExceptionStatus.NameResolutionFailure || webException.Status == WebExceptionStatus.ProtocolError)
            break;
    ...
    public void InitializeComponent()
    {
      ...
      Application.LoadComponent((object) this, new Uri("/Rift;V2.1.0.1;component/mainwindow.xaml", UriKind.Relative));
    }
